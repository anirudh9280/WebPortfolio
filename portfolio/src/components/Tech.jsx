...
const Tech = () => {
  ...
  // Darker gradient styles for light mode (avoiding light colors that are hard to read)
  const darkStyles = [
    "bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500",
    "bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-700",
    "bg-clip-text text-transparent bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-700",
    "bg-clip-text text-transparent bg-gradient-to-r from-red-800 via-yellow-600 to-yellow-500",
    "bg-clip-text text-transparent bg-gradient-to-r from-rose-700 to-pink-600",
    "bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-600 to-pink-600",
    "bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-orange-600",
    "bg-clip-text text-transparent bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-amber-600 via-violet-600 to-sky-900",
    "bg-clip-text text-transparent bg-gradient-to-r from-purple-800 via-violet-900 to-purple-800",
    "bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-lime-700",
    "bg-clip-text text-transparent bg-gradient-to-r from-rose-600 via-red-600 to-red-700",
    "bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-violet-800",
    "bg-clip-text text-transparent bg-gradient-to-r from-sky-600 to-cyan-700",
    "bg-clip-text text-transparent bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-yellow-600 via-purple-700 to-blue-700",
    "bg-clip-text text-transparent bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-rose-900 via-amber-800 to-rose-800",
    "bg-clip-text text-transparent bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-orange-900 via-amber-800 to-orange-900",
  ];

  // Use all styles in dark mode, but only darker styles in light mode
  const styles = darkMode ? allStyles : darkStyles;
      ...
      {technologies.map((technology) => {
        ...
        return (
          <div className="w-28 h-28" key={technology.name}>
            <h2 className={randomClass()} key={technology.name}>
              {technology.name}
            </h2>
          </div>
        );
